...
<body onload="startTimer(90)">
			...
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				<h2 class="text-muted">
					Datos y Documentos del Dueño Beneficiario o <small>
						Beneficiario Controlador, Persona Física.</small>
				</h2>
			</article>
			...
			<div class="col-md-9 table-responsive">
				...
				<form onsubmit="return validarBeneficiarioPersonaFisica()"
					...
					<table border="0" id="">
						...
						<tr>
							<td><label id="Imp5"> * Teléfono país </label> <select
							...
							<td id="Imp55">
								<div class="md-form form-sm">
									<input class="form-control" type="text" name="btelefono"
										...
										for="btelefono" class=""> * Teléfono </label>
								</div>
							</td>
						</tr>
						<tr id="Imp6">
							<td colspan="3">
								<div class="md-form form-sm">
									...
									<label for="tipo">* Correo electrónico </label><br /> <input
						...
						<tr>
							...
							<td></td>
							<td><label id="Imp10"> * País de nacimiento</label> <select
						...
						<tr>
							...
							<td><label id="Imp11"> * País de nacionalidad </label> <select
						...
						<tr>
							<td colspan="3"><label id="Imp13">* Actividad
									económica </label> <select class="browser-default" name="bactividadEco"
						...
						<tr>
							<td colspan="3" style="display: none;">
								<div class="md-form form-sm">
									...
									<label for="bbuscarActividadEco">* Actividad econóimica</label><br />
									<br>
								</div>
 ...
 %></td>
							...
							<td>
								<div class="md-form form-sm">
									<input class="form-control" type="text" name="bcp" id="bcp"
										...
										for="bcp" class=""> * Código Postal</label>
								</div>
							</td>
						</tr>
						<tr id="Imp21">
						...
						<tr>
							<td><label id="Imp22"> * País </label> <select
				...
				.ready(
						function() {
							...
							if (esEdicion == '1') {
								...
								//ASIGNANDO EL PAÍS DE NACIMIENTO
								...
								//ASIGNANDO EL PAÍS DE NACIONALIDAD
								...
								//ASIGNANDO LA ACTIVIDAD ECONÓMICA 
								
								txtActividadId = '${actividad_id}';
								
								if (txtActividadId != null 	|| txtActividadId.length > 0) {
									var selector = document
	...
	<script>
		...
		function validals() {
			...
			if (txtbcurp.length > 0) {
				...
				txtActivodadEco = document.getElementById('bactividadEco').value;
