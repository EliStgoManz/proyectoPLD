...
<body onload="startTimer(90)">
	...
	<div class="container">
		<div id="Imp3" class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				<h2 class="text-muted">
					Datos y Documentos del Dueño Beneficiario o <small>Beneficiario
				...
				<form onsubmit="return validarBeneficiarioPersonaMoral()"
					...
					<table border="0" id="">
						...
						<tr>
							...
							<td></td>
							<td><label id="Imp9"> * País </label> <select
 ...
 %></td>
						...
						<tr>
							<td><label id="Imp17"> * País </label> <select
 ...
 %></td>
		...
		$(document)
				.ready(
						function() {
							...
							//ASIGNANDO LOS DATOS CUÁNDO VIENEN DE LA CAPTURA
	...
	<script>
		...
		function validals() {
			txtRFC = document.getElementById('bRFC').value;
...
// 			txtRFC2 = document.getElementById('rlRFC').value;
// 			if (txtRFC2 == null || txtRFC2.length == 0
// 					|| /^\s+$/.test(txtRFC2)) {
// 				alert('El RFC del Representante no puede dejarse en blanco');
// 				document.getElementById('rlRFC').focus();
// 				return false;
// 			}
			txtGiro = document.getElementById('bGiro').value;
			if (txtGiro == null || txtGiro.length == 0
					|| /^\s+$/.test(txtGiro) || txtGiro == "1000000") {
				alert('Debe seleccionar un giro');
				document.getElementById('bGiro').focus();
				return false;
			}
