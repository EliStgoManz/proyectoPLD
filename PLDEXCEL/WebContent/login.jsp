	...
	<div class="container">
		<div class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				<h2 class="text-muted">Inicio de sesión</h2>
				<br> <label>Si usted ya es cliente de Efectivale e
					ingresa por primera vez, el usuario será su RFC y la contraseña el
					número de cliente (sin consignatarios).</label>
				...
				<form onsubmit="return validarFormulario()" name="frmLogin"
					...
					<table border="0">
						...
						<tr>
							...
							<td width="30px"></td>
							<!--<td>Prevención Lavado de Dinero (Persona Moral)</td>-->
						</tr>
						<tr>
