								...
								<td>
									<div class="row">
										<div class="col-12">
											...
											<br> <input id='Imp44' type="date" name="fechaBloqueo"
...
// 			 		 }
 ...
 %>
								...
								<td></td>
								<td>
									<button class="btn btn-danger" name="btnGuardar"
				...
				<div class="col-md-3">
					...
					%>
					<br> <a id="Impr"
						href="javascript:imprimir(Imp1,Imp2,Imp3,Imp4,Imp44,Imp5,Imp6,Imp7,Imp8,Imp9,Imp10,Imp11,Imp12,Imp13,Imp14,Imp15,Imp16,Imp17,Imp18,Imp19,Imp20,Imp21,Imp22,Imp23,Imp24,Imp25,Imp26,Imp27,Imp28,Imp29,Imp30,Imp31,Imp32,Imp33)">Imprimir
						pantalla.</a>
				</div>
			</div>
		</div>
...
// 			    	return true;
		...
		<script>
			function imprimir(Imp1, Imp2, Imp3, Imp4, Imp44, Imp5, Imp6, Imp7,
				...
				printContents += document.getElementById('Imp4').innerHTML
						+ document.getElementById('Imp44').innerHTML
